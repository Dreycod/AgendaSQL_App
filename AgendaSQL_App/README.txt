...
- Scaffold-DbContext "server=andreraspberrypi.local;port=3306;user=admin;password=*****;database=agenda_suzukidb" Pomelo.EntityFrameworkCore.MySql -OutputDir Agenda_db -f
